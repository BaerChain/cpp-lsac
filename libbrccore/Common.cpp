...
{
	string const c_line = BrcReset BrcOnMaroon + string(80, ' ') + BrcReset;
	string const c_border = BrcReset BrcOnMaroon + string(2, ' ') + BrcReset BrcMaroonBold;
	string const c_space = c_border + string(76, ' ') + c_border + BrcReset;
	stringstream ss;
	ss << c_line << "\n";
	ss << c_space << "\n";
