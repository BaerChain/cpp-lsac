...
// TODO: This one is specifically for BrcdChain, but we can make it generic in due course.
// TODO: hidden-partition style key-store.
/**
 * @brief High-level manager of password-encrypted keys for BrcdChain.
 * Usage:
 *
...
public:
	...
	static boost::filesystem::path defaultPath() { return getDataDir("brcdChain") / boost::filesystem::path("keys.info"); }
