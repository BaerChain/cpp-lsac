...
namespace dev
{
    ...
    struct DposContext
    {
        ...
        void streamRLPFields(RLPStream& _s) const
		{
			...
			_s_var << var_size;
			//cdebug << BrcRed"streamRLP var_size：" << var_size;
			for(auto val : varlitors_votes.m_varlitor_voter)
			{
				...
				//cdebug << BrcRed"streamRLP m_varlitor_voter voters size：" << val.second.size()<<"|"<< _s_var_votes.out().size();
        ...
        void printData () const
		{
			...
			std::cout << BrcBlue "vote_varlitor:{";
			...
			std::cout << BrcYellow "curr_varlitor:{";
			...
			std::cout << BrcYellow " varlitor_block_num: {";
