 ...
 */
        ...
        private:
            ...
            void streamRLPFields(RLPStream &_s, IncludeSeal _i = WithoutSign) const;
        ...
        inline std::ostream &operator<<(std::ostream &_out, BlockHeader const &_bi) {
            _out << _bi.hash(WithoutSeal) << " " << _bi.parentHash() << " " << _bi.sha3Uncles() << " " << _bi.author()
