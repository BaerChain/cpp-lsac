...
public:
	...
	virtual BRCSchedule const& brcSchedule(u256 const& _blockNumber) const = 0;
	...
	virtual bigint costOfPrecompiled(Address const& _a, bytesConstRef _in, u256 const& _blockNumber) const { return m_params.precompiled.at(_a).cost(_in);}
...
#define BRC_REGISTER_SEAL_ENGINE(Name) static SealEngineFactory __brc_registerSealEngineFactory ## Name = SealEngineRegistrar::registerSealEngine<Name>(#Name)

class NoProof: public brc::SealEngineBase
{
public:
...
u256 calculateBrchashDifficulty(
