...
CHAINBASE_SET_INDEX_TYPE(brc::db::order_object, brc::db::order_object_index)
CHAINBASE_SET_INDEX_TYPE(brc::db::order_result_object, brc::db::order_result_object_index)