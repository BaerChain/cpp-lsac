...
namespace brc
{
void SH_DposBadBlock::streamRLPFields(RLPStream& _s)
{
...
void SH_DposBadBlock::populate(RLP const& _rlp)
{
    size_t field = 0;
    ...
    {
        /*_e << errinfo_name("invalid msg format") << BadFieldError(field,
        toHex(_rlp[field].data().toBytes())); throw;*/
