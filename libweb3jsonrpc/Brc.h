...
public:
	...
	virtual Json::Value brc_getGasPrice(std::string const& _blockNumber) override;
    ...
    virtual Json::Value brc_getPermissionTransfer(std::string const& _address, std::string const& _blockNumber) override;
protected:
