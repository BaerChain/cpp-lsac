...
void dev::brc::State::newGetSellExChangeOrder(int64_t const& _time, u256 const& _price, std::pair<sellOrder::iterator, sellOrder::iterator> &_p)
{
    ...
    if(!_orderAccount)
    {
     ...
     _orderAccount->sellExchangeGetIt(_price, _time, m_db);
}
