...
{
public:
    explicit BlockChainSync(BrcdChainCapability& _host);
    ~BlockChainSync();
    ...
    void onPeerStatus(BrcdChainPeer const& _peer);
...
private:
    ...
    BrcdChainCapability& host() { return m_host; }
    BrcdChainCapability const& host() const { return m_host; }
