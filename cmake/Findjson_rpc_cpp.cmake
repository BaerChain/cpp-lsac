...
find_path(
        ...
        PATHS ${JSON_RPC_CPP_ROOT_DIR}/include
...
find_library(
        ...
        PATHS ${JSON_RPC_CPP_ROOT_DIR}/lib
...
message(STATUS "json rpc cpp root: ${JSON_RPC_CPP_ROOT_DIR}")
message(STATUS "json rpc cpp include: ${JSON_RPC_CPP_INCLUDE_DIR} (version: ${JSON_RPC_CPP_VERSION})")
message(STATUS "json rpc cpp common: ${JSON_RPC_CPP_COMMON_LIBRARY}")
message(STATUS "json rpc cpp server: ${JSON_RPC_CPP_SERVER_LIBRARY}")
message(STATUS "json rpc cpp client: ${JSON_RPC_CPP_CLIENT_LIBRARY}")
