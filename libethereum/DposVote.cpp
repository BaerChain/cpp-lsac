...
bool dev::eth::DposVote::verifyVote(Address const & _from, Address const & _to, size_t _type, size_t tickets)
{
    ...
    switch(dType)
    {
        case dev::eth::ENull:
        break;
		case dev::eth::EBuyVote:
		{
			return true;
		}
		break;
		case dev::eth::ESellVote:
		{ 
...
void dev::eth::DposVote::getSortElectors(std::vector<Address>& _electors, size_t _num) const
{
...
void dev::eth::DposVote::voteLoginCandidate(Address const& _addr)
{
	m_state.addSysVoteDate(SysElectorAddress, _addr);
}

void dev::eth::DposVote::voteLogoutCandidate(Address const& _addr)
{
