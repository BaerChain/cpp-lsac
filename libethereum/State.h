...
public:
    void transferBallotBuy(Address const& _from, Address const& _to, u256 const& _value) { subBalance(_from, _value * BALLOTPRICE); addBallot(_from, _value); addBalance(_to, _value * BALLOTPRICE);}
    void transferBallotSell(Address const& _from, Address const& _to, u256 const& _value) { subBallot(_from, _value); subBalance(_to, _value * BALLOTPRICE); addBalance(_from, _value * BALLOTPRICE); }
